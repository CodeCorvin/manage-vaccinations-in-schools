...
class Patient < ApplicationRecord
  ...
  before_save :set_local_authority_from_postcode, if: :address_postcode_changed?
  ...
  def set_local_authority_from_postcode
    self.local_authority_mhclg_code =
      LocalAuthority.for_postcode(address_postcode)&.mhclg_code
  end
